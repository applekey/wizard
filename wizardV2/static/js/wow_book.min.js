    ...
    n.prototype = {
        ...
        doPageNumbering: function () {
            ...
            if (a.pageNumbers) {
                ...
                for (b = e; b <= c; b++) a = d(".wowbook-page-number", this.pages[b]), a.length || (a = d(".wowbook-page-content", this.pages[b]), a = d('<div class="wowbook-page-number"></div>').appendTo(a)), a.html(Math.floor((f++) / 2) + 1)
            }
        },
